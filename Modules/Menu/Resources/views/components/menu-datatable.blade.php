<div class="datatable datatable-bordered datatable-head-custom" id="menu_datatable"></div>

@section('scripts')
    <script>
        (() => {
            const AppsMenuListDatatable = function () {
                const _default = () => {
                    const datatable = $('#menu_datatable').KTDatatable({
                        data: {
                            type: 'remote',
                            source: {
                                read: {
                                    url: APP_URL + '/api/menus',
                                },
                            },
                            pageSize: 10,
                            serverPaging: true,
