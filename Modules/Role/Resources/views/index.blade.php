    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Roles
                    <span class="d-block text-muted pt-2 font-size-sm">User role management</span>
                </h3>
            </div>
        ...
        <div class="card-body">
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="role_datatable"></div>
            <!--end: Datatable-->
        </div>
    </div>
@endsection
...
@section('scripts')
    <script src="{{ Module::asset('role:js/role-datatable.js') }}"></script>
@endsection
