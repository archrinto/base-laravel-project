...
--at--section('title', __('{{ $module['title'] ?? '' }}'))
    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">
                    Menus
                    <span class="d-block text-muted pt-2 font-size-sm">Application menu management</span>
                </h3>
            </div>
            <div class="card-toolbar">
                <a href="--bro-- route('{{ $module['key'] }}:create') --brc--" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            --at--include('{{ $module['key'] }}::components.datatable')
        </div>
    </div>
--at--endsection
