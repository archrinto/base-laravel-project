<div class="datatable datatable-bordered datatable-head-custom" id="module-name-datatable"></div>

@section('scripts')
    <script>
        (() => {
            const ModuleNameDatatable = function () {
                const _default = () => {
                    const datatable = $('#module-name-datatable').KTDatatable({
                        data: {
                            type: 'remote',
                            source: {
                                read: {
                                    url: APP_URL + '/api/fakes',
                                },
                            },
                            pageSize: 10,
                            serverPaging: true,
